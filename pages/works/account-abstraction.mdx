...
TL;DR: Account abstraction allows us to use and interact with smart contract without the need of EOA (externally own accounts). It permit smart contracts to define what is a valid transaction via a set of specific method and interfaces with their own logic.
