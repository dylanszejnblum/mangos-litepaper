...
Private keys are vital for the functioning of a blockchain, as they allows us to sign transaction and are also the key to identity and ownership inside this system. And although things like seed phrases allow for an easier way of storing and safe guarding your are asset the drawbacks still lingers.
...
## The Trojan horse of exchanges and custodial solutions
